...
public class ModSounds {
    ...
    public static final RegistryObject<SoundEvent> CARGO_DELIVERY = SOUNDS.register("cargo_delivery", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(DysonSphere.MODID, "cargo_delivery")));
}
