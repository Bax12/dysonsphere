...
public class InputHatchSerialGui extends BaseGui<InputHatchSerialContainer> {
    
    public static final ResourceLocation RES_LOC = AssetUtil.getGuiLocation("gui_input_hatch_serial");
    private final InputHatchTile.Serial tile;
    private HeatDisplay heat;
    private final boolean isHeat;

    public InputHatchSerialGui(InputHatchSerialContainer container, Inventory inventory, Component pTitle){
