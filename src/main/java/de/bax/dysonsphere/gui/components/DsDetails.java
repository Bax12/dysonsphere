...
public class DsDetails implements Renderable {
    ...
    public void render(@Nonnull GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        AssetUtil.renderMaxWidthString(pGuiGraphics, Component.translatable("tooltip.dysonsphere.ds_monitor_status"), x + 2, y + 2, width - 4, 0xFFFFFFFF, 0, 0xF000F0, true);
        AssetUtil.renderMaxWidthString(pGuiGraphics, Component.translatable("tooltip.dysonsphere.ds_monitor_completion", df.format(tile.getDsCompletionPercentage())), x + 2, y + 12, width - 4, 0xFFF0F0F0, 0, 0xF000F0, true);

        df.setMaximumFractionDigits(0);

        AssetUtil.renderMaxWidthString(pGuiGraphics, Component.translatable("tooltip.dysonsphere.ds_monitor_capacity", df.format(tile.getDsEnergy())), x + 2, y + 22, width - 4, 0xFFF0F0F0, 0, 0xF000F0, true);
        AssetUtil.renderMaxWidthString(pGuiGraphics, Component.translatable("tooltip.dysonsphere.ds_monitor_parts"), x + 2, y + 32, width - 4, 0xFFF0F0F0, 0, 0xF000F0, true);
