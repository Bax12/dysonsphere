...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<DeliveryDropEntity>> DELIVERY_DROP = ENTITIES.register("delivery_drop", () -> EntityType.Builder.of((EntityType.EntityFactory<DeliveryDropEntity>) DeliveryDropEntity::new, MobCategory.MISC).setTrackingRange(256).updateInterval(10).setShouldReceiveVelocityUpdates(true).sized(0.15f, 0.15f).build(""));
