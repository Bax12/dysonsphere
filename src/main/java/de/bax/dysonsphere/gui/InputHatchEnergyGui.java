...
public class InputHatchEnergyGui extends BaseGui<InputHatchEnergyContainer> {

    public static final ResourceLocation RES_LOC = AssetUtil.getGuiLocation("gui_input_hatch_energy");
    private final InputHatchTile.Energy tile;
    private EnergyDisplay energy;
    private HeatDisplay heat;
    private final boolean isHeat;

    public InputHatchEnergyGui(InputHatchEnergyContainer container, Inventory inventory, Component pTitle) {
    ...
    protected void init() {
        super.init();
        this.energy = new EnergyDisplay(this.leftPos + 33, this.topPos + 5, tile.energyStorage);
        if(isHeat){
